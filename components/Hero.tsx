...
const Hero: React.FC = () => {
  return (
    <section id="hero" className="relative bg-[#f0f2f5] dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden h-[90vh] flex flex-col justify-center items-center text-center p-8 mb-12 scroll-mt-20">
      {/* Decorative shapes */}
